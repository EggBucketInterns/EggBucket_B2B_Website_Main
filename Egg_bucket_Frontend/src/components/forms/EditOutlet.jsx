...
const EditOutlet = ({ outlet, onClose, onSave }) => {
  ...
  useEffect(() => {
    const fetchOutletPartners = async () => {
      try {
        const response = await fetch('http://localhost:3577/outletPartners/egg-bucket-b2b/displayAll-outlet_partner');
    ...
    const fetchDeliveryPartners = async () => {
      try {
        const response = await fetch('http://localhost:3577/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner');
