...
const AddNewOutlet = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:3577/egg-bucket-b2b/get-all-outlets')
    ...
    fetch(
      'http://localhost:3577/outletPartners/egg-bucket-b2b/displayAll-outlet_partner'
    )
      .then((response) => response.json())
      .then((data) => {
        if (data.status === 'success') {
    ...
    fetch(
      'http://localhost:3577/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner'
    )
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:3577/egg-bucket-b2b/create-outlet', {
      method: 'POST',
      body: formDataToSend,
    })
      .then((response) => response.json())
