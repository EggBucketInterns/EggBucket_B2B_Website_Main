...
const AddNewCustomer = () => {
  ...
  useEffect(() => {
    // Fetch all outlets
    // fetch('http://eggbucket-website.onrender.com/egg-bucket-b2b/get-all-outlets')
    ...
    // Fetch all customers
    fetch('http://eggbucket-website.onrender.com/customers/egg-bucket-b2b/getAllCustomer')
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
    ...
    fetch('http://eggbucket-website.onrender.com.1:3577/egg-bucket-b2b/get-all-outlets')
      .then(response => response.json())
      .then(data => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit form data
      const response = await fetch('http://eggbucket-website.onrender.com/customers/egg-bucket-b2b/create-customer', {
        method: 'POST',
        body: formDataToSend,
      });
